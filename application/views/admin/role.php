              ...
              <table class="table table-hover">
      				  ...
      				  <tbody>
      				    ...
      				    <tr>
      				      ...
      				      <td><?= $r['role']; ?></td>
      				      <td>
                      <a class="badge badge-pill badge-warning" href="<?= base_url('admin/roleaccess/') . $r['id']; ?>">Akses</a>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="modalRoleLabel">Tambah Level Jabatan Baru</h5>
            ...
            <form action="<?= base_url('admin/role'); ?>" method="post">
            	<div class="modal-body">
          		  <input type="text" class="form-control" id="role" name="role" placeholder="Nama Jabatan">
            	</div>
